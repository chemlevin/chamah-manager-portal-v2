...
const screenshots = [
  ...
  { name: 'desktop-organization-accounting', width: 1440, height: 900, route: 'dashboards/unit/organization/accounting/summary', ready: '#general-dashboard' },
  ...
  { name: 'tablet-accounting-dashboard', width: 820, height: 1180, route: `dashboards/unit/${activeOfficeId}/accounting/summary`, ready: '#general-dashboard' },
  ...
  { name: 'mobile-accounting-dashboard', width: 390, height: 844, route: `dashboards/unit/${activeOfficeId}/accounting/summary`, ready: '#general-dashboard' },
