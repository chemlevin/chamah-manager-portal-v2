...
const portalSectionLabels = {
  home: 'עמוד הבית', dashboards: 'דשבורדים', 'dashboards.finance': 'כספים', 'dashboards.accounting': 'הנה״ח', 'dashboards.licensing': 'רישוי', 'dashboards.team': 'צוות', 'dashboards.staffing': 'צוות ורישוי', 'dashboards.occupancy': 'תפוסה ותקינה',
  ...
  management: 'הרשאות וטבלאות', 'management.permissions': 'הרשאות', 'management.permissions.users': 'רשימת משתמשים והרשאות', 'management.rules': 'כללים', 'management.rules.calculation': 'כללי חישוב', 'management.rules.system': 'כללי מערכת', 'management.tables': 'טבלאות', 'management.tables.calculation': 'טבלאות חישוב', 'management.tables.variables': 'משתנים', 'management.audit': 'יומן שינויים',
