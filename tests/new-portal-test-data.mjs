...
const portalSectionLabels = {
  home: 'עמוד הבית', dashboards: 'דשבורדים', 'dashboards.finance': 'דשבורד כספים', 'dashboards.accounting': 'הנה״ח', 'dashboards.accounting.summary': 'דשבורד סיכום', 'dashboards.accounting.banks': 'קובץ בנקים', 'dashboards.staffing': 'צוות ורישוי', 'dashboards.occupancy': 'תפוסה ותקינה',
