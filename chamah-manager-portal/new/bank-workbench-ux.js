...
export async function mountBankWorkbenchV2(request) {
  ...
  const exportColumns = ["#","סטטוס","חשבון בנק","תאריך","תיאור","אסמכתא","סכום","סוג תנועה","מחלקה","מעון","סעיף תקציבי","חודש הנה״ח","סטטוס הנה״ח","הערות","מסמכים"];
